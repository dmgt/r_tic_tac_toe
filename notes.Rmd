...
# Combine plotting teh board and transforming the digits based on user plays 
...
```{r}
# Test function
plot_board(player_1_moves = c(4,5), player_2_moves = c(9,8))
```
...
```{r}
new_list_of_winning_moves <- list(c("1", "2", "3"), 
                                  c("1", "3", "2"), 
                                  c("3", "1", "2"),
                                  c( "3", "2", "1"),
                                  c("2", "3", "1"),
