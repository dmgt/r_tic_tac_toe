...
tic_tac_toe <- function ()  {
    ...
    vector_of_winning_moves <- c("123", "132", "312", "321", "231", "213",  # 3 horizontal wins
                             "456", "465", "645", "654", "564", "546",
                             "789", "798", "978", "987", "897", "879",  
                             "147", "174", "714", "741", "471", "417",  # 3 vertical wins
                             "258", "285", "825", "852", "582", "528",
                             "369", "396", "936", "963", "693", "639",
                             "159", "195", "915", "951", "591", "519",  # 2 diagonal wins
   ...
   print(glue("Player 1 moves so far: {player_1_moves}"))
   
   inputs2 <- player2_initial_prompt()
   
   player_2_moves <- inputs2$n
   
    print(glue("Player 2 moves so far: {player_2_moves}"))  
}
```

```{r}
# Test displaying a grid

# Adapted from example that used a totally different numbering scheme https://www.robert-hickman.eu/post/r-inforcement_learning_one/
  
plot_board <- function() {
  pieced <- glue_collapse(c("1", "2", "3", "4", "5", "6", "7", "8", "9"), sep = " | ")
...
test_vector2 <- c("132")
test_vector3 <- c("537")
test_vector_short <- c("12")
test_vector_mismatch <-c("157")

test_vector1 %in% vector_of_winning_moves
test_vector2 %in% vector_of_winning_moves
test_vector3 %in% vector_of_winning_moves
test_vector_short %in% vector_of_winning_moves
test_vector_mismatch %in% vector_of_winning_moves
```
